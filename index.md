...
<div style="display: flex; gap: 20px; align-items: flex-start; margin-bottom: 2.5em;">
  ...
  <div>
    ...
    <p style="margin: 0;">On quantum dynamics and continuous states.</p>
  </div>
</div>
...
<div style="display: flex; gap: 20px; align-items: flex-start; margin-bottom: 2.5em;">
  ...
  <div>
    ...
    <p style="margin: 0;">A toy problem about optimizing the trade-off between information collection and lost opportunity, in the context of recruiting.</p>
  </div>
</div>
...
<div style="display: flex; gap: 20px; align-items: flex-start; margin-bottom: 2.5em;">
  ...
  <div>
    <h2 style="margin-top: 0; margin-bottom: 0.2em;"><a href="airbus.html">Ship Detection</a></h2>
...
<div style="display: flex; gap: 20px; align-items: flex-start; margin-bottom: 2.5em;">
  ...
  <div>
    <h2 style="margin-top: 0; margin-bottom: 0.2em;"><a href="fmow.html">Satellite Image Classification</a></h2>
...
<div style="display: flex; gap: 20px; align-items: flex-start; margin-bottom: 2.5em;">
  ...
  <div>
    ...
    <p style="margin: 0;">The optimal policy for the dice game <em>Threes</em>.</p>
  </div>
</div>
...
<div style="display: flex; gap: 20px; align-items: flex-start; margin-bottom: 2.5em;">
  ...
  <div>
    ...
    <p style="margin: 0;">An Arduino robot that learns to crawl using reinforcement learning, with a video about RL and how it's implemented in the robot.</p>
  </div>
</div>
