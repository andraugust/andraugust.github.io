...
The binomial coefficient comes from choosing which ranks to put on the left of $$r$$, and the factorials come from the permutations.
...
The optimal policy is to hire if $$r$$ is better than the best so-far and  $$r/R  \ge V(r+1)$$.
